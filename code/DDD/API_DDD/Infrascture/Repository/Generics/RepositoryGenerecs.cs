...
namespace Infrascture.Repository.Generics
{
    public class RepositoryGenerecs<T> : IGeneric<T>, IDisposable where T : class
    {
        ...
        public async Task<T> GenEntityById(int Id)
        {
            using (var data = new ContextBase(_OptionBuilder))
            {
